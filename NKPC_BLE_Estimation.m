...
M_.param_names = char(M_.param_names, 'beta_pi');
M_.param_names_tex = char(M_.param_names_tex, 'beta\_pi');
M_.param_names_long = char(M_.param_names_long, 'beta_pi');
...
erase_compiled_function('NKPC_BLE_Estimation_static');
erase_compiled_function('NKPC_BLE_Estimation_dynamic');
M_.orig_eq_nbr = 5;
M_.eq_nbr = 5;
M_.ramsey_eq_nbr = 0;
...
%
M_.exo_det_length = 0;
M_.Sigma_e(1, 1) = (0.7322)^2;
M_.Sigma_e(2, 2) = (0.2950)^2;
M_.Sigma_e(3, 3) = (0.2908)^2;
options_.ar = 10;
options_.nograph = 1;
var_list_ = char();
info = stoch_simul(var_list_);
save('NKPC_BLE_Estimation_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('NKPC_BLE_Estimation_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('NKPC_BLE_Estimation_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('NKPC_BLE_Estimation_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('NKPC_BLE_Estimation_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('NKPC_BLE_Estimation_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('NKPC_BLE_Estimation_results.mat', 'oo_recursive_', '-append');
end
