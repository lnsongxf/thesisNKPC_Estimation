function [residual, g1, g2, g3] = NKPC_BLE_Estimation_static(y, x, params)
%
...
lhs =y(1);
rhs =y_forecast__-1/params(2)*(y(3)-pi_forecast__)+y(4);
residual(1)= lhs-rhs;
lhs =y(2);
rhs =pi_forecast__*beta__+y(1)*params(1)+y(5);
residual(2)= lhs-rhs;
lhs =y(3);
